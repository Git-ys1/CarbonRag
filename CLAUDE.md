...
This project is indexed by GitNexus as **CarbonRag** (8229 symbols, 16087 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Work in the Tests area (229 symbols) | `.claude/skills/generated/tests/SKILL.md` |
| Work in the Rag area (210 symbols) | `.claude/skills/generated/rag/SKILL.md` |
| Work in the Knowledge area (118 symbols) | `.claude/skills/generated/knowledge/SKILL.md` |
| Work in the Services area (71 symbols) | `.claude/skills/generated/services/SKILL.md` |
| Work in the Carbon area (60 symbols) | `.claude/skills/generated/carbon/SKILL.md` |
...
| Work in the Endpoints area (41 symbols) | `.claude/skills/generated/endpoints/SKILL.md` |
...
| Work in the Session area (26 symbols) | `.claude/skills/generated/session/SKILL.md` |
