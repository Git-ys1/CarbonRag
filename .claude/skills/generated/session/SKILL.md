---
name: session
description: "Skill for the Session area of CarbonRag. 28 symbols across 5 files."
---

# Session

28 symbols | 5 files | Cohesion: 65%

## When to Use

- Working with code in `backend/`
- Understanding how utcnow, get_active_stream_registry, build_sse_event work
...
| File | Symbols |
|------|---------|
| `backend/app/session/service.py` | utcnow, require_session, begin_exchange, finalize_exchange, record_system_message (+8) |
...
| `list_attached_private_sample_ids` | Method | `backend/app/session/service.py` | 330 |
| `list_attached_knowledge_item_ids` | Method | `backend/app/session/service.py` | 333 |
| `list_session_knowledge_items` | Method | `backend/app/session/service.py` | 337 |
